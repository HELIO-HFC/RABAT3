FUNCTION get_gsfc_swaves_data,date,spacecraft, $
                              datapath=datapath, $
...
;          data = get_gsfc_swaves_data('20070101','A',found=found,/DOWNLOAD_FILE)
;
; HISTORY:
...
IF (n_params() LT 2) THEN BEGIN
    ...
    print,'data = get_gsfc_swaves_data(date,spacecraft, $' 
