FUNCTION read_waves_gsfc_rad1,file,header,$
...
;
; PURPOSE:
; 	Read Wind/Waves Rad1 data file YYYYMMDD.R1(.Z)
...
;
; CALLING SEQUENCE:
;	IDL> intensity = read_waves_gsfc_rad1(file,header)
;
; INPUTS:
;	file - Scalar of string type containing the pathname of the rad1 data file.
;	
; OPTIONAL INPUTS:
;	None.
;
...
bandwidth = 3000. ;Hz
integration_time = 154.0e-3 ; sec

intensity=0b
header=0b
if not (keyword_set(file)) then begin
   message,/INFO,'Call is:'
   print,'intensity = read_waves_gsfc_rad1(file, header, $'
