FUNCTION get_waves_gsfc_data,date, $
                             datapath=datapath, $
                             filepath=filepath, $
                             found=found,url=url, $
...
;          data = get_waves_gsfc_data('20010101',found=found,/DOWNLOAD_FILE)
;
; HISTORY:
...
if (n_params() lt 1) then begin
    ...
    print,'data = get_waves_gsfc_data(date,datapath=datapath, $'
